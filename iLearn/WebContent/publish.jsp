...
<body class="body">
	...
	<div class="container" style="background-color: white; padding: 10px;">
		...
		<div class="well">
			...
			<fieldset>
				<legend> Do You Want To Publish The Package? </legend>
			</fieldset>


			<form class="form-horizontal" name="publishPackage" action="Publish"
				method="POST">
