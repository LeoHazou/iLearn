...
<body class="body">
	...
	<div class="container" style="background-color: white; padding: 10px;">
		...
		<div class="well">
			<fieldset>
				<legend> Edit Administrator Info </legend>
			</fieldset>
					...
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-hand-right"></i></span> <input
								...
								name="firstName" required <% if ( request.getParameter("firstName") != null){ %> value="<%=request.getParameter("firstName") %>" <% } %>>
						</div>
					</div>
				</div>
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-hand-right"></i></span> <input
								type="text" class="input-xlarge"
								name="lastName" required <% if ( request.getParameter("lastName") != null){ %> value="<%=request.getParameter("lastName") %>" <% } %>>
					...
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><i class="icon-hand-right"></i></span> <input
								...
								name="email" <% if ( request.getParameter("email") != null){ %> value="<%= request.getParameter("email") %>" <% } %>
								required>
						</div>
					</div>
				</div>
				...
				<div class="control-group ">
									...
									<div class="controls">
										<label class="radio inline"> <input type="radio"
											...
											<%if (request.getParameter("type").equals("SuperAdministrator")) {%> checked="checked"
											<%}%>> <a>SuperAdministrator </a>
										</label> <label class="radio inline"> <input type="radio"
											name="type" value="Administrator" required="required"
											<%if (request.getParameter("type").equals("Administrator")) {%>
				...
				<div class="control-group ">
									...
									<div class="controls">
										<label class="radio inline"> <input type="radio"
											...
											<%if (request.getParameter("gender").equals("Male")) {%> checked="checked"
											<%}%>> <a>Male </a>
										</label> <label class="radio inline"> <input type="radio"
											...
											<%if (request.getParameter("gender").equals("Other")) {%> checked="checked"
											<%}%>> <a> Other</a>
										</label>
									</div>
								</div>
